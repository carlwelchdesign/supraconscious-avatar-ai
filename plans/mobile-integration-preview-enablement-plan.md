...
- Verify iOS Simulator launch with `flutter run -d 'iPhone 17' --dart-define=INNER_COUNCIL_API_BASE_URL=http://localhost:3000`.
...
- iOS local preview requires an installed iOS Simulator runtime; this local setup uses iOS 26.5 with iPhone 17.
